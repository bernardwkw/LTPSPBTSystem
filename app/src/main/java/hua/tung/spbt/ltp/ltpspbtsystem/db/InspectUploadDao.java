...
/** 
 * DAO for table "INSPECT_UPLOAD".
*/
public class InspectUploadDao extends AbstractDao<InspectUpload, String> {

    public static final String TABLENAME = "INSPECT_UPLOAD";

    /**
     * Properties of entity InspectUpload.<br/>
     * Can be used for QueryBuilder and for referencing column names.
     */
    public static class Properties {
        public final static Property Inspect_id = new Property(0, String.class, "inspect_id", true, "INSPECT_ID");
    ...
    public InspectUploadDao(DaoConfig config) {
        super(config);
    }
    
    public InspectUploadDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"INSPECT_UPLOAD\" (" + //
                "\"INSPECT_ID\" TEXT PRIMARY KEY NOT NULL ," + // 0: inspect_id
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"INSPECT_UPLOAD\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, InspectUpload entity) {
        stmt.clearBindings();
 
        String inspect_id = entity.getInspect_id();
        if (inspect_id != null) {
            stmt.bindString(1, inspect_id);
        }
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, InspectUpload entity) {
        stmt.clearBindings();
    ...
    @Override
    public InspectUpload readEntity(Cursor cursor, int offset) {
        InspectUpload entity = new InspectUpload( //
            cursor.isNull(offset + 0) ? null : cursor.getString(offset + 0), // inspect_id
    ...
    @Override
    public void readEntity(Cursor cursor, InspectUpload entity, int offset) {
        entity.setInspect_id(cursor.isNull(offset + 0) ? null : cursor.getString(offset + 0));
    ...
    @Override
    protected final String updateKeyAfterInsert(InspectUpload entity, long rowId) {
        return entity.getInspect_id();
    }
    
    @Override
    public String getKey(InspectUpload entity) {
        if(entity != null) {
            return entity.getInspect_id();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(InspectUpload entity) {
